...
Abdulaziz Kikanga  ·  https://www.linkedin.com/in/abdulazizkikanga/ ·  github.com/abdulazizkikanga/zora-retention-stack
Project Overview
...
Loyalty → At-Risk → Dormant
Trigger: first_mint event fires on-chain	Collector Track
Acquisition → Activation → Engagement
Loyalty → At-Risk → Dormant
Trigger: first_collect event fires on-chain
...
70%+
User churn rate across NFT platforms	61K+
Dormant wallets with email addresses	+25%
Projected retention lift from this system
